...
#outFileName = "pt1_histos_run2023B.root"
#treeFileName = "Events"
...
def create_hists(fileName,plotName,treeName,evnum):
    ...
    for entry in tree:
        ...
        if mjj != -999.0:
            if 250 < mjj < 350:
                hist_250to350.Fill(pt1)
            elif 350 < mjj < 500:
                hist_350to500.Fill(pt1)
            elif 500 < mjj < 650:
                hist_500to650.Fill(pt1)
            elif 650 < mjj < 850:
                hist_650to850.Fill(pt1)
            elif 850 < mjj < 1100:
                hist_850to1100.Fill(pt1)
            elif 1100 < mjj < 1400:
                hist_1100to1400.Fill(pt1)
            elif 1400 < mjj < 1800:
                hist_1400to1800.Fill(pt1)
            elif 1800 < mjj < 2200:
                hist_1800to2200.Fill(pt1)
            elif 2200 < mjj:
                hist_over2200.Fill(pt1)
